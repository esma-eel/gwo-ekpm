...
def test_5_3_2_astro_data():
    data = test_5_3_2_data_extraction(
        ...
        "/results/ekpm2/5.3.1.2/astro/ekpm2_5.3.2_astro.json"
    )
...
def test_5_3_2_ham_data():
    data = test_5_3_2_data_extraction(
        "/home/esmaeel/work/thesis/thesis_main/src"
        "/results/ekpm2/5.3.1.2/ham/ekpm2_5.3.2_ham.json"
    )
...
def test_5_3_2_pgp_data():
    data = test_5_3_2_data_extraction(
        "/home/esmaeel/work/thesis/thesis_main/src"
        "/results/ekpm2/5.3.1.2/pgp/ekpm2_5.3.2_pgp.json"
    )
...
plt.title("Evaluation Influentiality [Propogation PRB] (EKPM 2)")
plt.legend()
plt.show()
