...
def test_5_3_2_ham_data():
    data = test_5_3_2_data_extraction(
        "/home/esmaeel/work/thesis/thesis_main/src"
        "/results/ekpm/5.3.1.2/ham/ekpm_5.3.2_s2_ham.json"
    )
...
def test_5_3_2_pgp_data():
    data = test_5_3_2_data_extraction(
        "/home/esmaeel/work/thesis/thesis_main/src"
        "/results/ekpm/5.3.1.2/pgp/ekpm_5.3.2_s2_pgp.json"
    )
...
plt.title("Evaluation Influentiality [Propogation PRB] (EKPM S2)")
plt.legend()
plt.show()
