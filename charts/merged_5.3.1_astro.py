...
def test_5_3_1_gwim_data():
    data = test_5_3_1_data_extraction(
        ...
        "/results/gwim/5.3.1.1/astro/gwim_default_5.3.1.1_out.json"
    )
...
def test_5_3_1_ekpm_s1_data():
    data = test_5_3_1_data_extraction(
        "/home/esmaeel/work/thesis/thesis_main/src"
        "/results/ekpm/5.3.1.1/astro/ekpm_5.3.1_s1_astro.json"
    )
...
def test_5_3_1_ekpm_s2_data():
    data = test_5_3_1_data_extraction(
        "/home/esmaeel/work/thesis/thesis_main/src"
        "/results/ekpm/5.3.1.1/astro/ekpm_5.3.1_s2_astro.json"
    )
...
plt.title("Evaluation Influentiality [Seed Set Size] (ASTRO)")
plt.legend()
plt.show()
