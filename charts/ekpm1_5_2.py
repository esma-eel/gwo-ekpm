...
def test_5_2_astro_data():
    data = test_5_2_data_extraction(
        ...
        "/results/ekpm1/5.2/astro/ekpm1_5.2_astro.json"
    )

    graph_data = test_5_2_graph_data(data, 0, 600, 0, 10)
    return graph_data
...
def test_5_2_ham_data():
    data = test_5_2_data_extraction(
        "/home/esmaeel/work/thesis/thesis_main/src"
        "/results/ekpm1/5.2/ham/ekpm1_5.2_ham.json"
    )
...
def test_5_2_pgp_data():
    data = test_5_2_data_extraction(
        "/home/esmaeel/work/thesis/thesis_main/src"
        "/results/ekpm1/5.2/pgp/ekpm1_5.2_pgp.json"
    )

    graph_data = test_5_2_graph_data(data, 0, 100, 0, 10)
    return graph_data
...
plt.ylabel("AM")
plt.title("Convergence Speed (EKPM 1)")
plt.legend()
plt.show()
