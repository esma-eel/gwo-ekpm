...
def test_5_2_gwim_data():
    data = test_5_2_data_extraction(
        ...
        "/results/gwim/5.2/gwim_ham.json"
    )

    graph_data = test_5_2_graph_data(data, 0, 9, 0, 10)
    return graph_data
...
def test_5_2_ekpm_s1_data():
    data = test_5_2_data_extraction(
        "/home/esmaeel/work/thesis/thesis_main/src"
        "/results/ekpm/5.2/s1/ekpm_s1_ham.json"
    )

    graph_data = test_5_2_graph_data(data, 0, 10, 0, 10)
    return graph_data
...
def test_5_2_ekpm_s2_data():
    data = test_5_2_data_extraction(
        "/home/esmaeel/work/thesis/thesis_main/src"
        "/results/ekpm/5.2/s2/ekpm_s2_ham.json"
    )

    graph_data = test_5_2_graph_data(data, 0, 22, 0, 10)
    return graph_data
...
plt.ylabel("AM")
plt.title("Convergence Speed (HAM)")
plt.legend()
plt.show()
